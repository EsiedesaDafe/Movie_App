    ...
    const onLayoutRootView = useCallback(async () => {
      ...
      return (
        <View style={style.container} onLayout={onLayoutRootView}>
            ...
            <ImageBackground source={require('../../assets/IMAGES/T.jpg')} style={style.ImgStyle} >
            ...
            <View style={style.HeadViewStyle}>
                <View>
                    ...
                    <Text style={style.pBText}>Thor Love and Thunder</Text>
            ...
            <View style={style.SecondTextViewStyle}>
                ...
                <Text numberOfLines={2} style={style.SecondText}>Cast ; Chris Hemsworth · Thor ; Natalie Portman · Jane Foster ; Christian Bale · Gorr ; Tessa Thompson · King Valkyrie ; Taika Waititi · Korg ...</Text>
            </View>
