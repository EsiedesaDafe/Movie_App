    ...
    const onLayoutRootView = useCallback(async () => {
      ...
      return (
        <View style={style.container} onLayout={onLayoutRootView}>
            ...
            <ImageBackground source={require('../../assets/IMAGES/Q.jpg')} style={style.ImgStyle} >
            ...
            <View style={style.HeadViewStyle}>
                <View>
                    ...
                    <Text style={style.pBText}>Spider Man</Text>
            ...
            <View style={style.SecondTextViewStyle}>
                <Text numberOfLines={3} style={style.FirstText}> Spider-Man seeks the help of Doctor Strange to forget his exposed secret identity as Peter Parker. However, Strange's spell goes horribly wrong, leading to unwanted guests entering their universe.</Text>
                <Text numberOfLines={2} style={style.SecondText}>Cast ; Tom Holland · Peter Parker ; Zendaya · MJ ; Benedict Cumberbatch · Doctor Strange ; Jacob Batalon · Ned Leeds ; Jon Favreau · Happy Hogan.</Text>
            </View>
