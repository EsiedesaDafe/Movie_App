    ...
    const onLayoutRootView = useCallback(async () => {
      ...
      return (
        <View style={style.container} onLayout={onLayoutRootView}>
            ...
            <ImageBackground source={require('../../assets/IMAGES/S.jpg')} style={style.ImgStyle} >
            ...
            <View style={style.HeadViewStyle}>
                <View>
                    ...
                    <Text style={style.pBText}>Sonic the hedgehog</Text>
            ...
            <View style={style.SecondTextViewStyle}>
                <Text numberOfLines={3} style={style.FirstText}> After settling in Green Hills, Sonic is eager to prove that he has what it takes to be a true hero. His test comes when Dr. Robotnik returns with a new partner, Knuckles, in search of a mystical emerald that has the power to destroy civilizations. Sonic teams up with his own sidekick, Tails, and tog…</Text>
                <Text numberOfLines={2} style={style.SecondText}>Cast ; James Marsden · Tom Wachowski ; Jim Carrey · Dr. Robotnik ; Ben Schwartz · Sonic ; Tika Sumpter · Maddie Wachowski ; Idris Elba · Knuckles ...</Text>
            </View>
