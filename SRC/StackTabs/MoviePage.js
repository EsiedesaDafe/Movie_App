...
const MoviePage = () => {
    ...
    return (
        <View style={style.container} onLayout={onLayoutRootView}>
            ...
            <ImageBackground source={require('../../assets/IMAGES/P.png')} style={style.ImgStyle} >
            ...
            <View style={style.HeadViewStyle}>
                <View>
                    <Text style={style.seriesText}>Series</Text>
                    <Text style={style.pBText}>Power book II</Text>
                    <Text style={style.subText}>Crime, Drama</Text>
                </View>
                <View style={style.IconStyle}>
            ...
            <View style={style.SecondTextViewStyle}>
                <Text numberOfLines={3} style={style.FirstText}> Ghost picks up shortly after the earth-shattering events of Power as Tariq St. Patrick grapples with a new world order.</Text>
                <Text numberOfLines={2} style={style.SecondText}>Cast ; Michael Rainey Jr. Tariq St. Patrick ; Shane Johnson · Cooper Saxe ... more</Text>
            </View>
